...
public class CompoundInterest {
    ...
    static double futureValue(double presentValue, double rate,
        ...
        while (years!=0){
            presentValue = presentValue * (100+rate)/100;
            years = years - 1;
    ...
    static double futureValueReal(double presentValue, double rate,
        ...
        double raw_val = futureValue(presentValue,rate,targetYear);
        int years = numYears(targetYear);
        while (years!=0){
            raw_val = raw_val * (100 - inflationRate)/100;
            years = years -1;
        }
        return raw_val;
    }
    ...
    static double totalSavings(double perYear, int targetYear, double rate) {
        ...
        double TotalSave = 0;
        while (years>=0){
            TotalSave = TotalSave + futureValue(perYear,rate,(targetYear-years));
            years = years - 1;
        }
        return TotalSave;
    }
    ...
    static double totalSavingsReal(double perYear, int targetYear, double rate,
        ...
        double TotalSave = 0;
        while (years>=0){
            TotalSave = TotalSave + futureValueReal(perYear,rate,(targetYear-years),inflationRate);
            years = years - 1;
        }
        return TotalSave;
